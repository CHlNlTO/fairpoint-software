// features/chart-of-accounts/components/tax-types/tax-types-table.tsx
...
import { TaxTypeActions } from './tax-type-actions';

interface TaxTypesTableProps {
  data?: TaxType[];
  isLoading?: boolean;
  filters: TaxTypeFilters;
  onFiltersChange: (filters: Partial<TaxTypeFilters>) => void;
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
        <div className="flex flex-col sm:flex-row gap-2 flex-1">
          ...
          >
            ...
            <SelectContent>
              {TAX_TYPE_STATUS_OPTIONS.map(option => (
      ...
      <div className="flex gap-2 items-center">
        ...
        >
          ...
          <SelectContent>
            {TAX_TYPE_SORT_OPTIONS.map(option => (
              <SelectItem key={option.value} value={option.value}>
                {option.label}
              </SelectItem>
            ))}
        ...
        <Table>
          ...
          <TableBody>
            {isLoading ? (
              ...
              filteredAndSortedData.map(taxType => (
                <TableRow key={taxType.id}>
                  ...
                  <TableCell>
                    {new Date(taxType.created_at).toLocaleDateString()}
                  </TableCell>
                  <TableCell>
                    <TaxTypeActions
                      taxType={taxType}
