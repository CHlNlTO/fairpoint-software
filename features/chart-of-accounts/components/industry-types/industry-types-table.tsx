// features/chart-of-accounts/components/industry-types/industry-types-table.tsx
...
import { IndustryTypeActions } from './industry-type-actions';

interface IndustryTypesTableProps {
  data?: IndustryType[];
  isLoading?: boolean;
  filters: IndustryTypeFilters;
  onFiltersChange: (filters: Partial<IndustryTypeFilters>) => void;
...
export function IndustryTypesTable({
  data = [],
  isLoading = false,
  filters,
  onFiltersChange,
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
        <div className="flex flex-col sm:flex-row gap-2 flex-1">
          ...
          >
            ...
            <SelectContent>
              {INDUSTRY_TYPE_STATUS_OPTIONS.map(option => (
      ...
      <div className="flex gap-2 items-center">
        ...
        >
          ...
          <SelectContent>
            {INDUSTRY_TYPE_SORT_OPTIONS.map(option => (
              <SelectItem key={option.value} value={option.value}>
                {option.label}
              </SelectItem>
            ))}
        ...
        <Table>
          ...
          <TableBody>
            {isLoading ? (
              ...
              filteredAndSortedData.map(industryType => (
                <TableRow key={industryType.id}>
                  ...
                  <TableCell>
                    {new Date(industryType.created_at).toLocaleDateString()}
                  </TableCell>
                  <TableCell>
                    <IndustryTypeActions
